...
productController.create = async (req, res) => {
    try {
        ...
        const company = await Company.findOne({ userId: req.user._id, companyName: req.body.companyName })
        if (!company) {
...
productController.findByCompanyName = async (req, res) => {
    try {
        ...
        const findProduct = await Product.find({ userId: req.user._id, companyName: req.query.companyName })
